...
from model import OfflineItemSimilarity
import os
...
def set_datapath() -> None:
    ...
    args.train_path = f"{args.data_dir}{args.data_name}_train_{args.subseq_len}.txt"
    ...
    args.time_subseqs_path = f"{args.data_dir}{args.data_name}_subseq_{args.subseq_len}_time.txt"
...
def main() -> None:
    ...
    train_user_seq = get_user_seqs(args.subseqs_path if not args.graph_split else args.seqs_path)
    ...
    args.subseq_id_map, _, _, _ = TargetSubseqs.get_subseq_id_map(args.subseqs_path)
